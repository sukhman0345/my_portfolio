...
import Image1 from "../components/link_images/project4_1.png";
import Image2 from "../components/link_images/project4_2.png";
import Image3 from "../components/link_images/project4_3.png";
import Image4 from "../components/link_images/project4_4.png";
  ...
  return (
    <Container maxWidth="xl" sx={{ overflow: "hidden", padding: 0 }}>
      ...
      <Box textAlign="center" py={4}>
        ...
        >
          The Currency Converter is a web application built using HTML, CSS, and
          JavaScript. It allows users to convert currencies in real time by
          fetching the latest exchange rates from an external API.🚀
